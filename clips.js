...
<head>
    ...
    <style>
        ...
        .clip-card:hover .clip-thumbnail { transform: scale(1.05); }
        ...
        .clip-info { padding: 1.5rem; flex-grow: 1; display: flex; flex-direction: column; }
        .clip-title {
        ...
        .clip-meta { margin-top: auto; display: flex; justify-content: space-between; align-items: center; }
        .clip-creator { font-size: 0.75rem; font-weight: 700; color: var(--accent); text-transform: uppercase; letter-spacing: 0.5px; }
        .clip-stats { font-size: 0.8rem; color: var(--text-dim); font-weight: 500; }

        /* Barre de recherche Premium */
        .search-container { position: relative; margin-bottom: 3rem; max-width: 600px; }
        .search-input {
            width: 100%; padding: 16px 20px 16px 52px; background: var(--surface);
...
<body>
    ...
    <main>
        ...
        <div class="search-container">
            ...
            <input type="text" id="clipSearch" class="search-input" placeholder="Rechercher par titre ou par clipper..." onkeyup="filterClips()">
        </div>
        ...
        <div id="clips-root" class="clips-grid">
            ...
            <div style="grid-column: 1 / -1; text-align: center; padding: 5rem;">
                ...
                <p style="color: var(--text-dim); font-weight: 600; text-transform: uppercase; letter-spacing: 1px;">Chargement des clips Twitch...</p>
            </div>
        </div>
    </main>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", async () => {
            ...
            try {
                ...
                console.error(error);
                document.getElementById("clips-root").innerHTML = `<p style="color:var(--danger); grid-column:1/-1; text-align:center;">Erreur lors du chargement des clips.</p>`;
            }
        });
