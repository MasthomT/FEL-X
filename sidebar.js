document.addEventListener("DOMContentLoaded", () => {
    ...
    // 2. Icônes SVG Minimalistes (Lucide) + AJOUT FAQ
    const icons = {
        ...
        faq: `<svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>`,
    ...
    <nav id="felx-sidebar">
        ...
        <div class="nav-links">
            ...
            <!-- AJOUT DU BOUTON FAQ ICI -->
            <a href="faq.html" class="nav-link ${location.pathname.includes('faq') ? 'active' : ''}">
                ${icons.faq} <span class="nav-text">FAQ</span>
            </a>
        </div>
