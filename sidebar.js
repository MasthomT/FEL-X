    ...
    <div class="sidebar">
        ...
        <div class="nav-links" style="display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <a href="clips.html" class="nav-link ${currentPage === 'clips.html' ? 'active' : ''}">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="2.18" ry="2.18"></rect><line x1="7" y1="2" x2="7" y2="22"></line><line x1="17" y1="2" x2="17" y2="22"></line></svg>
                <span class="nav-text">Clips</span>
            </a>
            <a href="faq.html" class="nav-link ${currentPage === 'faq.html' ? 'active' : ''}">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path></svg>
                <span class="nav-text">FAQ Secrets</span>
            </a>
            <a href="infos.html" class="nav-link ${currentPage === 'infos.html' ? 'active' : ''}">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line></svg>
