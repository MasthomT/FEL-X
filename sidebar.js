    ...
    <div class="sidebar">
        ...
        <div class="nav-links" style="display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <a href="clips.html" class="nav-link ${currentPage === 'clips.html' ? 'active' : ''}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><rect x="2" y="2" width="20" height="20" rx="2.18" ry="2.18"></rect><line x1="7" y1="2" x2="7" y2="22"></line><line x1="17" y1="2" x2="17" y2="22"></line></svg>
            ...
            <a href="#" id="logout-btn" class="nav-link logout" style="margin-top: auto;">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline></svg>
